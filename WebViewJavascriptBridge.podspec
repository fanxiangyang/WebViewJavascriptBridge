Pod::Spec.new do |s|
  ...
  s.homepage     = 'https://github.com/fanxiangyang/WebViewJavascriptBridge'
  s.license      = { :type => 'MIT', :file => 'LICENSE' }
  s.author       = { 'fanxiangyang' => 'fqsyfan@gmail.com' }
  s.source       = { :git => 'https://github.com/fanxiangyang/WebViewJavascriptBridge.git', :tag => 'v'+s.version.to_s }
